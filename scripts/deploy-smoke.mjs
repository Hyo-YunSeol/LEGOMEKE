...
assert.ok(index.includes('/app.js?v=610111'), 'index.html app cache version is not 610111.');
assert.ok(index.includes('/styles.css?v=610111'), 'index.html style cache version is not 610111.');
assert.ok(sw.includes("const VERSION = '610111'"), 'service worker cache version is not 610111.');
assert.ok(app.includes("/sw.js?v=610111"), 'app service worker registration cache version is not 610111.');
assert.equal(JSON.parse(pkg).version, '6.10.11', 'package version mismatch.');
