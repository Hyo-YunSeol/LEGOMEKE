...
assert.ok(index.includes('/app.js?v=610117'), 'index.html app cache version is not 610117.');
assert.ok(index.includes('/styles.css?v=610117'), 'index.html style cache version is not 610117.');
assert.ok(sw.includes("const VERSION = '610117'"), 'service worker cache version is not 610117.');
assert.ok(app.includes("/sw.js?v=610117"), 'app service worker registration cache version is not 610117.');
assert.equal(JSON.parse(pkg).version, '6.10.17', 'package version mismatch.');
