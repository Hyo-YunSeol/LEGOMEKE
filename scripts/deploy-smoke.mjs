...
assert.ok(index.includes('/app.js?v=69203'), 'index.html app cache version is not 69203.');
assert.ok(index.includes('/styles.css?v=69203'), 'index.html style cache version is not 69203.');
assert.ok(sw.includes("const VERSION = '69203'"), 'service worker cache version is not 69203.');
assert.ok(app.includes("/sw.js?v=69203"), 'app service worker registration cache version is not 69203.');
