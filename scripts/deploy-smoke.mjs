...
assert.ok(index.includes('/app.js?v=69901'), 'index.html app cache version is not 69901.');
assert.ok(index.includes('/styles.css?v=69901'), 'index.html style cache version is not 69901.');
assert.ok(sw.includes("const VERSION = '69901'"), 'service worker cache version is not 69901.');
assert.ok(app.includes("/sw.js?v=69901"), 'app service worker registration cache version is not 69901.');
assert.equal(JSON.parse(pkg).version, '6.9.9', 'package version mismatch.');
