...
assert.ok(index.includes('/app.js?v=610106'), 'index.html app cache version is not 610106.');
assert.ok(index.includes('/styles.css?v=610106'), 'index.html style cache version is not 610106.');
assert.ok(sw.includes("const VERSION = '610106'"), 'service worker cache version is not 610106.');
assert.ok(app.includes("/sw.js?v=610106"), 'app service worker registration cache version is not 610106.');
assert.equal(JSON.parse(pkg).version, '6.10.6', 'package version mismatch.');
