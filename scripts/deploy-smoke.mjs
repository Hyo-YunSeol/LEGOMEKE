...
assert.ok(index.includes('/app.js?v=610109'), 'index.html app cache version is not 610109.');
assert.ok(index.includes('/styles.css?v=610109'), 'index.html style cache version is not 610109.');
assert.ok(sw.includes("const VERSION = '610109'"), 'service worker cache version is not 610109.');
assert.ok(app.includes("/sw.js?v=610109"), 'app service worker registration cache version is not 610109.');
assert.equal(JSON.parse(pkg).version, '6.10.9', 'package version mismatch.');
