...
assert.ok(index.includes('/app.js?v=610114'), 'index.html app cache version is not 610114.');
assert.ok(index.includes('/styles.css?v=610114'), 'index.html style cache version is not 610114.');
assert.ok(sw.includes("const VERSION = '610114'"), 'service worker cache version is not 610114.');
assert.ok(app.includes("/sw.js?v=610114"), 'app service worker registration cache version is not 610114.');
assert.equal(JSON.parse(pkg).version, '6.10.14', 'package version mismatch.');
