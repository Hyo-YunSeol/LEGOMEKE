...
assert.ok(index.includes('/app.js?v=610101'), 'index.html app cache version is not 610101.');
assert.ok(index.includes('/styles.css?v=610101'), 'index.html style cache version is not 610101.');
assert.ok(sw.includes("const VERSION = '610101'"), 'service worker cache version is not 610101.');
assert.ok(app.includes("/sw.js?v=610101"), 'app service worker registration cache version is not 610101.');
assert.equal(JSON.parse(pkg).version, '6.10.1', 'package version mismatch.');
