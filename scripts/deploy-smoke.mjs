...
assert.ok(index.includes('/app.js?v=610112'), 'index.html app cache version is not 610112.');
assert.ok(index.includes('/styles.css?v=610112'), 'index.html style cache version is not 610112.');
assert.ok(sw.includes("const VERSION = '610112'"), 'service worker cache version is not 610112.');
assert.ok(app.includes("/sw.js?v=610112"), 'app service worker registration cache version is not 610112.');
assert.equal(JSON.parse(pkg).version, '6.10.12', 'package version mismatch.');
