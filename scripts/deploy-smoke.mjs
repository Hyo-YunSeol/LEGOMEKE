...
assert.match(worker, /APP_VERSION = '6\.10\.27-stability-final'/);
assert.match(index, /styles\.css\?v=6101270/);
assert.match(index, /app\.js\?v=6101270/);
assert.match(app, /sw\.js\?v=6101270/);
assert.match(sw, /const CACHE = 'lego-life-v6101270-stability-final'/);
...
console.log('Deploy smoke OK: v6.10.27 stability final assets and existing game features are connected.');
