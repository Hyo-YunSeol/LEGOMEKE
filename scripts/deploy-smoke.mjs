...
assert.ok(index.includes('/app.js?v=610103'), 'index.html app cache version is not 610103.');
assert.ok(index.includes('/styles.css?v=610103'), 'index.html style cache version is not 610103.');
assert.ok(sw.includes("const VERSION = '610103'"), 'service worker cache version is not 610103.');
assert.ok(app.includes("/sw.js?v=610103"), 'app service worker registration cache version is not 610103.');
assert.equal(JSON.parse(pkg).version, '6.10.3', 'package version mismatch.');
