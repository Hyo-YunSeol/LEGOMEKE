...
assert.ok(index.includes('/app.js?v=69401'), 'index.html app cache version is not 69401.');
assert.ok(index.includes('/styles.css?v=69401'), 'index.html style cache version is not 69401.');
assert.ok(sw.includes("const VERSION = '69401'"), 'service worker cache version is not 69401.');
assert.ok(app.includes("/sw.js?v=69401"), 'app service worker registration cache version is not 69401.');
assert.equal(JSON.parse(pkg).version, '6.9.4', 'package version mismatch.');
