...
assert.ok(index.includes('/app.js?v=610104'), 'index.html app cache version is not 610104.');
assert.ok(index.includes('/styles.css?v=610104'), 'index.html style cache version is not 610104.');
assert.ok(sw.includes("const VERSION = '610104'"), 'service worker cache version is not 610104.');
assert.ok(app.includes("/sw.js?v=610104"), 'app service worker registration cache version is not 610104.');
assert.equal(JSON.parse(pkg).version, '6.10.4', 'package version mismatch.');
