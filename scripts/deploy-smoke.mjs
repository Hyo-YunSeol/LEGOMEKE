...
assert.ok(index.includes('/app.js?v=610001'), 'index.html app cache version is not 610001.');
assert.ok(index.includes('/styles.css?v=610001'), 'index.html style cache version is not 610001.');
assert.ok(sw.includes("const VERSION = '610001'"), 'service worker cache version is not 610001.');
assert.ok(app.includes("/sw.js?v=610001"), 'app service worker registration cache version is not 610001.');
assert.equal(JSON.parse(pkg).version, '6.10.0', 'package version mismatch.');
