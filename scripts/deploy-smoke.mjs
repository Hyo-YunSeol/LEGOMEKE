...
assert.ok(index.includes('/app.js?v=610120'), 'index.html app cache version is not 610120.');
assert.ok(index.includes('/styles.css?v=610120'), 'index.html style cache version is not 610120.');
assert.ok(sw.includes("const VERSION = '610120'"), 'service worker cache version is not 610120.');
assert.ok(app.includes("/sw.js?v=610120"), 'app service worker registration cache version is not 610120.');
assert.equal(JSON.parse(pkg).version, '6.10.20', 'package version mismatch.');
