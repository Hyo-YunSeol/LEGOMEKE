...
assert.match(styles, /\.sichuan-cell img\{[^}]*width:66%;height:66%/);
...
console.log('Deploy smoke OK: v6.10.22 assets, Sichuan themes, body ranking, retired-game cleanup are connected.');
