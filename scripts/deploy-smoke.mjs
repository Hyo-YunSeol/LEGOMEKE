...
assert.ok(index.includes('/app.js?v=610110'), 'index.html app cache version is not 610110.');
assert.ok(index.includes('/styles.css?v=610110'), 'index.html style cache version is not 610110.');
assert.ok(sw.includes("const VERSION = '610110'"), 'service worker cache version is not 610110.');
assert.ok(app.includes("/sw.js?v=610110"), 'app service worker registration cache version is not 610110.');
assert.equal(JSON.parse(pkg).version, '6.10.10', 'package version mismatch.');
