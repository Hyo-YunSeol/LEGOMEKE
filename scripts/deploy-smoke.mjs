...
assert.ok(index.includes('/app.js?v=610121'), 'index.html app cache version is not 610121.');
assert.ok(index.includes('/styles.css?v=610121'), 'index.html style cache version is not 610121.');
assert.ok(sw.includes("const VERSION = '610121'"), 'service worker cache version is not 610121.');
assert.ok(app.includes("/sw.js?v=610121"), 'app service worker registration cache version is not 610121.');
assert.equal(JSON.parse(pkg).version, '6.10.21', 'package version mismatch.');
