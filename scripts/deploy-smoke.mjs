...
assert.ok(index.includes('/app.js?v=610113'), 'index.html app cache version is not 610113.');
assert.ok(index.includes('/styles.css?v=610113'), 'index.html style cache version is not 610113.');
assert.ok(sw.includes("const VERSION = '610113'"), 'service worker cache version is not 610113.');
assert.ok(app.includes("/sw.js?v=610113"), 'app service worker registration cache version is not 610113.');
assert.equal(JSON.parse(pkg).version, '6.10.13', 'package version mismatch.');
