...
assert.ok(index.includes('/app.js?v=69501'), 'index.html app cache version is not 69501.');
assert.ok(index.includes('/styles.css?v=69501'), 'index.html style cache version is not 69501.');
assert.ok(sw.includes("const VERSION = '69501'"), 'service worker cache version is not 69501.');
assert.ok(app.includes("/sw.js?v=69501"), 'app service worker registration cache version is not 69501.');
assert.equal(JSON.parse(pkg).version, '6.9.5', 'package version mismatch.');
