...
assert.match(sw, /const CACHE = 'lego-life-v6101231-legodoku-final'/);
...
console.log('Deploy smoke OK: v6.10.23 Legodoku final assets and existing game features are connected.');
