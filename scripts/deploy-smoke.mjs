...
assert.ok(index.includes('/app.js?v=69801'), 'index.html app cache version is not 69801.');
assert.ok(index.includes('/styles.css?v=69801'), 'index.html style cache version is not 69801.');
assert.ok(sw.includes("const VERSION = '69801'"), 'service worker cache version is not 69801.');
assert.ok(app.includes("/sw.js?v=69801"), 'app service worker registration cache version is not 69801.');
assert.equal(JSON.parse(pkg).version, '6.9.8', 'package version mismatch.');
