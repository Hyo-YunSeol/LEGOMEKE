...
assert.ok(index.includes('/app.js?v=610115'), 'index.html app cache version is not 610115.');
assert.ok(index.includes('/styles.css?v=610115'), 'index.html style cache version is not 610115.');
assert.ok(sw.includes("const VERSION = '610115'"), 'service worker cache version is not 610115.');
assert.ok(app.includes("/sw.js?v=610115"), 'app service worker registration cache version is not 610115.');
assert.equal(JSON.parse(pkg).version, '6.10.15', 'package version mismatch.');
