...
assert.ok(index.includes('/app.js?v=610102'), 'index.html app cache version is not 610102.');
assert.ok(index.includes('/styles.css?v=610102'), 'index.html style cache version is not 610102.');
assert.ok(sw.includes("const VERSION = '610102'"), 'service worker cache version is not 610102.');
assert.ok(app.includes("/sw.js?v=610102"), 'app service worker registration cache version is not 610102.');
assert.equal(JSON.parse(pkg).version, '6.10.2', 'package version mismatch.');
