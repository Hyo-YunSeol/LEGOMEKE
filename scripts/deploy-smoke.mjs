...
assert.ok(index.includes('/app.js?v=610108'), 'index.html app cache version is not 610108.');
assert.ok(index.includes('/styles.css?v=610108'), 'index.html style cache version is not 610108.');
assert.ok(sw.includes("const VERSION = '610108'"), 'service worker cache version is not 610108.');
assert.ok(app.includes("/sw.js?v=610108"), 'app service worker registration cache version is not 610108.');
assert.equal(JSON.parse(pkg).version, '6.10.8', 'package version mismatch.');
