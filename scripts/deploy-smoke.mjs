...
assert.ok(index.includes('/app.js?v=610118'), 'index.html app cache version is not 610118.');
assert.ok(index.includes('/styles.css?v=610118'), 'index.html style cache version is not 610118.');
assert.ok(sw.includes("const VERSION = '610118'"), 'service worker cache version is not 610118.');
assert.ok(app.includes("/sw.js?v=610118"), 'app service worker registration cache version is not 610118.');
assert.equal(JSON.parse(pkg).version, '6.10.18', 'package version mismatch.');
