...
assert.ok(index.includes('/app.js?v=610119'), 'index.html app cache version is not 610119.');
assert.ok(index.includes('/styles.css?v=610119'), 'index.html style cache version is not 610119.');
assert.ok(sw.includes("const VERSION = '610119'"), 'service worker cache version is not 610119.');
assert.ok(app.includes("/sw.js?v=610119"), 'app service worker registration cache version is not 610119.');
assert.equal(JSON.parse(pkg).version, '6.10.19', 'package version mismatch.');
