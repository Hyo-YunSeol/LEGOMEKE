...
test('모바일 SVG 합성 안정화와 v6.10.19 캐시 버전을 함께 배포한다', () => {
  ...
  assert.match(index, /styles\.css\?v=610119/);
  assert.match(index, /app\.js\?v=610119/);
  assert.match(app, /spot-difference-scene\.js\?v=610119/);
  assert.match(app, /sw\.js\?v=610119/);
  assert.match(sw, /const VERSION = '610119'/);
});
