...
test('v6.10.2 캐시·HTML·Worker 버전이 모두 일치한다', () => {
  ...
  assert.match(sw, /lego-life-v610102-sichuan-incremental-render-final/);
  assert.match(sw, /const VERSION = '610102'/);
  assert.match(worker, /APP_VERSION = '6\.10\.2-sichuan-incremental-render-final'/);
});
