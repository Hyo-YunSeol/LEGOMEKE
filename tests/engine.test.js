...
test('몸집 단계는 돼룩돼룩 이후 돼지 최종구간과 장기 공룡구간까지 연속된다', () => {
  const cases = [
    [0,'마름레고'],[60,'마름레고'],[69,'마름레고'],[70,'보통레고'],[129,'돼지레고'],
    [130,'코끼리레고'],[159,'코끼리레고'],[160,'맘모스레고'],[199,'맘모스레고'],
    [200,'돼룩돼룩레고'],[239,'돼룩돼룩레고'],[240,'왕돼룩레고'],[300,'괴물돼지레고'],
    [380,'프로토케라톱스레고'],[480,'파키케팔로사우루스레고'],[740,'안킬로사우루스레고'],
    [1080,'트리케라톱스레고'],[1500,'티라노사우루스레고'],[2030,'스피노사우루스레고'],
    [3510,'브라키오사우루스레고'],[5100,'드레드노투스레고'],[6440,'파타고티탄레고'],
    [7200,'아르헨티노사우루스레고'],[999999,'아르헨티노사우루스레고']
  ];
  for (const [body, label] of cases) assert.equal(getBodyStage(body).label, label);
  assert.equal(BODY_STAGES.length, 32);
