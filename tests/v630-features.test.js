...
import { interactionHungerCostForBody, consumeInteractionHunger } from '../src/game/activity.js';
import {
  createBung,
  finishBung,
  joinBung,
...
test('체형별 게임성 활동 배고픔 비용은 최신 1·2·3·4 단계 규칙을 따른다', () => {
  const cases = [
    [60, 1], [99, 1],
    [100, 2], [129, 2],
    [130, 3], [159, 3],
    [160, 4], [199, 4], [200, 4], [999, 4]
  ];
