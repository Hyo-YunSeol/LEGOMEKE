...
test('테트리스 로컬 입력은 고정 200칸을 건드리지 않고 별도 active 레이어만 이동한다', () => {
  ...
  assert.match(app, /paintBlockBattleBoard\(player, document, \{ activeOnly: true, preserveActiveOnMissing: true \}\)/);
});
