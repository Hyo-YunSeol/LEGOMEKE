...
test('리워크 플렉스 상품은 레벨에 따라 선호 장비와 고급 장비 가격이 구분되고 24시간 유지된다', () => {
  const expected = {
    sunglasses: 400,
    headset: 650,
    gamingHeadset: 950,
