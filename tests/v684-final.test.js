...
test('현재 배포 버전과 정적 자산 캐시는 함께 올라간다', async () => {
  ...
  assert.match(pkg, /"version": "6\.10\.20"/);
  assert.match(worker, /6\.10\.20-advancement-shop-spotdiff-semantic-final/);
  assert.match(index, /\?v=610120/);
  assert.match(app, /\?v=610120/);
