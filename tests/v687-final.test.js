...
test('v6.9.0 배포 버전과 캐시는 690으로 동기화된다', async () => {
  ...
  assert.match(html, /styles\.css\?v=69101/);
  assert.match(html, /app\.js\?v=69101/);
  assert.match(app, /\/sw\.js\?v=69101/);
  assert.match(sw, /lego-life-v69101-final/);
  assert.match(sw, /VERSION = '69101'/);
