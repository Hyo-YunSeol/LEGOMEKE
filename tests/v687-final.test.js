...
test('v6.8.9 배포 버전과 캐시는 689로 동기화된다', async () => {
  ...
  assert.match(html, /styles\.css\?v=68944/);
  assert.match(html, /app\.js\?v=68944/);
  assert.match(app, /\/sw\.js\?v=68944/);
  assert.match(sw, /lego-life-v6894-final/);
  assert.match(sw, /VERSION = '6894'/);
