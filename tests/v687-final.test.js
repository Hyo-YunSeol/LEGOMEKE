...
test('v6.10.25 배포 버전과 캐시는 6101250으로 동기화된다', async () => {
  ...
  assert.match(sw, /VERSION = '6101250'/);
  assert.match(worker, /APP_VERSION = '6\.10\.25-safe-fixes-final'/);
  assert.equal(JSON.parse(pkg).version, '6.10.25');
});
