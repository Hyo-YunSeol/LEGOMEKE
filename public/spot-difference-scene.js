...
const SPOT_ATLAS_ASSET_VERSION = 2;
const SPOT_ATLAS_CACHE_VERSION = '610117';

export function spotDifferenceAssetUrls(puzzle) {
  if (!puzzle || Number(puzzle.assetVersion || 0) !== SPOT_ATLAS_ASSET_VERSION) return null;
  ...
  return {
    original: `${root}-base.webp?v=${SPOT_ATLAS_CACHE_VERSION}`,
    changed: `${root}-changed.webp?v=${SPOT_ATLAS_CACHE_VERSION}`
  };
}
