  ...
  return `
    ...
    <section class="section">
      ...
      <div class="action-grid">
        ...
        <button class="action-card life-action" data-action="cook" type="button" ${lifeActionsLocked() || pet.stats.hunger >= 100 ? 'disabled' : ''}><span>🍳</span><strong>요리하기</strong><small>포만감 +50 · 최대 100</small></button>
