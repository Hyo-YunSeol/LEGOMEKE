...
import { renderSpotDifferenceScene, spotDifferenceHitIdAt, spotDifferenceThemeLabel } from './spot-difference-scene.js?v=610115';
...
function updateSpotDifferenceClock(room = currentSpotDifferenceRoom()) {
  ...
  $$('[data-spot-start-countdown]').forEach((node) => { node.textContent = String(Math.max(1, startSeconds || 1)); });
