// v6.10.21: 레비아탄 전직 · 플렉스 상점 리워크 · 성인 난이도 실사형 틀린그림찾기 v6 · 경기 DOM 고정
// · 대전 로비 중복/TMI 설명 정리 · 3방 · 30초 · 3→2→1 · 오답 5회 패배 · 최근 200판 중복 방지.
const CACHE = 'lego-life-v610121-advancement-shop-spotdiff-semantic-final';
const VERSION = '610121';
