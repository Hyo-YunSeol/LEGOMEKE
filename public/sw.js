// v6.10.1: Sichuan absolute 80-slot board + server-backed battle result room cleanup; preserves single Tetris 2-minute mode.
const CACHE = 'lego-life-v610101-sichuan-incremental-render-final';
const VERSION = '610101';
