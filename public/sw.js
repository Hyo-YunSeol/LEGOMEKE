// v6.9.9: single Tetris 2-minute limit; keeps spawn timing, Sichuan fixed-slot grid, and common result features.
const CACHE = 'lego-life-v69901-single-tetris-viewport-final';
const VERSION = '69901';
