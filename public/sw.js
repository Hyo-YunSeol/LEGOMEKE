// v6.10.11: 1:1 Tetris isolates the live visual board and blocks generic full-DOM refreshes during play.
const CACHE = 'lego-life-v610111-battle-tetris-sync-final';
const VERSION = '610111';
const versioned = (path) => `${path}?v=${VERSION}`;
const ASSETS = ['/', versioned('/styles.css'), versioned('/app.js'), versioned('/block-battle-visual-state.js'), '/manifest.webmanifest', versioned('/icons/icon-192.png'), versioned('/icons/icon-512.png'), versioned('/icons/icon-maskable-512.png'), ...[
