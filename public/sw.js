// v6.10.28: full gameplay stability fixes + synchronized static asset cache.
const CACHE = 'lego-life-v6101280-full-fix-final';
const VERSION = '6101280';
const versioned = (path) => `${path}?v=${VERSION}`;
const versionedSichuan = (path) => `${path}?v=${VERSION}&s=6101281`;
