// v6.10.4: apple mobile layout hardening + compact abandon + territory end history; preserves server-authoritative rules.
const CACHE = 'lego-life-v610104-apple-territory-final';
const VERSION = '610104';
