// v6.10.0: Sichuan absolute 80-slot board + server-backed battle result room cleanup; preserves single Tetris 2-minute mode.
const CACHE = 'lego-life-v610001-sichuan-room-cleanup-final';
const VERSION = '610001';
