// v6.9.8: single Tetris 2-minute limit; keeps spawn timing, Sichuan fixed-slot grid, and common result features.
const CACHE = 'lego-life-v69801-single-tetris-2min-final';
const VERSION = '69801';
