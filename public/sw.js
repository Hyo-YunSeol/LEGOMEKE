// v6.10.6: season champion badges + one-time Sichuan retroactive award + admin PIN reset; preserves v6.10.5 tetris flicker fix.
const CACHE = 'lego-life-v610106-season-badges-pin-final';
const VERSION = '610106';
