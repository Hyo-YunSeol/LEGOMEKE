// v6.10.27: mobile/minigame stability hardening + synchronized static asset cache.
const CACHE = 'lego-life-v6101270-stability-final';
const VERSION = '6101270';
const versioned = (path) => `${path}?v=${VERSION}`;
const versionedSichuan = (path) => `${path}?v=${VERSION}&s=6101271`;
...
].map((tileId) => versionedSichuan(`/sichuan/themes/${theme}/${tileId}.svg`)))];
