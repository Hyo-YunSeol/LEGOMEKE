// v6.10.2: Sichuan zero-wait queued input + mobile minigame viewport hardening; preserves server-authoritative rules.
const CACHE = 'lego-life-v610102-sichuan-incremental-render-final';
const VERSION = '610102';
