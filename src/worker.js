...
const APP_VERSION = '6.10.25-safe-fixes-final';
...
export class LegoGameRoom {
  ...
  bootstrapFromState(state, userId) {
    ...
    return {
      ...
      rankings: { ...rankingsView(state, pet.id), blockBattle: blockBattleRankings(state, pet.id), sichuan: sichuanRanking(state, pet.id), legodoku: legodokuRanking(state, pet.id) },
