...
// v6.10.19부터 신규 문제는 로컬 WebP 장면의 실제 픽셀을 국소 이동·반전·확대하는 방식으로 차이를 만든다.
// 임의의 세모·점·숫자표 같은 인공 마커는 사용하지 않는다. 20장면 × C(18,7) 조합과 플레이어별 최근 200판 중복 방지는 유지한다.
// assetVersion 2/3 진행방은 배포 중 대전을 깨지 않도록 호환한다.
...
export const SPOT_DIFFERENCE_ATLAS_VERSION = 4;
