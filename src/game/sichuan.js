...
const lifeTiles = [
  { id: 'cat', label: '마른레고', src: '/sichuan/themes/life/cat.svg' },
  { id: 'soccer', label: '왕레고', src: '/sichuan/themes/life/soccer.svg' },
  { id: 'crown', label: '프로토레고', src: '/sichuan/themes/life/crown.svg' },
  { id: 'moon', label: '트리케라레고', src: '/sichuan/themes/life/moon.svg' },
  { id: 'diamond', label: '스테고레고', src: '/sichuan/themes/life/diamond.svg' },
  { id: 'guitar', label: '브라키오레고', src: '/sichuan/themes/life/guitar.svg' },
  { id: 'book', label: '대왕고래레고', src: '/sichuan/themes/life/book.svg' },
  { id: 'planet', label: '크라켄레고', src: '/sichuan/themes/life/planet.svg' },
  { id: 'flower', label: '심해괴물레고', src: '/sichuan/themes/life/flower.svg' },
  { id: 'dragon', label: '베헤모스레고', src: '/sichuan/themes/life/dragon.svg' },
  { id: 'sword', label: '펜리르레고', src: '/sichuan/themes/life/sword.svg' },
  { id: 'shield', label: '히드라레고', src: '/sichuan/themes/life/shield.svg' },
  { id: 'teddy', label: '오로치레고', src: '/sichuan/themes/life/teddy.svg' },
  { id: 'skate', label: '가루다레고', src: '/sichuan/themes/life/skate.svg' },
  { id: 'coffee', label: '니드호그레고', src: '/sichuan/themes/life/coffee.svg' },
  { id: 'ribbon', label: '요르문간드레고', src: '/sichuan/themes/life/ribbon.svg' },
  { id: 'trident', label: '아펩레고', src: '/sichuan/themes/life/trident.svg' },
  { id: 'sunglasses', label: '아틀라스레고', src: '/sichuan/themes/life/sunglasses.svg' },
  { id: 'briefcase', label: '수르트레고', src: '/sichuan/themes/life/briefcase.svg' },
  { id: 'crystal', label: '레비아탄레고', src: '/sichuan/themes/life/crystal.svg' }
];

const natureTiles = [
  { id: 'cat', label: '사과', src: '/sichuan/themes/nature/cat.svg' },
  { id: 'soccer', label: '피자', src: '/sichuan/themes/nature/soccer.svg' },
  { id: 'crown', label: '햄버거', src: '/sichuan/themes/nature/crown.svg' },
  { id: 'moon', label: '케이크', src: '/sichuan/themes/nature/moon.svg' },
  { id: 'diamond', label: '도넛', src: '/sichuan/themes/nature/diamond.svg' },
  { id: 'guitar', label: '초밥', src: '/sichuan/themes/nature/guitar.svg' },
  { id: 'book', label: '라면', src: '/sichuan/themes/nature/book.svg' },
  { id: 'planet', label: '아이스크림', src: '/sichuan/themes/nature/planet.svg' },
  { id: 'flower', label: '수박', src: '/sichuan/themes/nature/flower.svg' },
  { id: 'dragon', label: '커피', src: '/sichuan/themes/nature/dragon.svg' },
  { id: 'sword', label: '계란', src: '/sichuan/themes/nature/sword.svg' },
  { id: 'shield', label: '치킨', src: '/sichuan/themes/nature/shield.svg' },
  { id: 'teddy', label: '당근', src: '/sichuan/themes/nature/teddy.svg' },
  { id: 'skate', label: '딸기', src: '/sichuan/themes/nature/skate.svg' },
  { id: 'coffee', label: '바나나', src: '/sichuan/themes/nature/coffee.svg' },
  { id: 'ribbon', label: '포도', src: '/sichuan/themes/nature/ribbon.svg' },
  { id: 'trident', label: '식빵', src: '/sichuan/themes/nature/trident.svg' },
  { id: 'sunglasses', label: '치즈', src: '/sichuan/themes/nature/sunglasses.svg' },
  { id: 'briefcase', label: '타코', src: '/sichuan/themes/nature/briefcase.svg' },
  { id: 'crystal', label: '팝콘', src: '/sichuan/themes/nature/crystal.svg' }
];

const fantasyTiles = [
  { id: 'cat', label: '고양이', src: '/sichuan/themes/fantasy/cat.svg' },
  { id: 'soccer', label: '강아지', src: '/sichuan/themes/fantasy/soccer.svg' },
  { id: 'crown', label: '사자', src: '/sichuan/themes/fantasy/crown.svg' },
  { id: 'moon', label: '판다', src: '/sichuan/themes/fantasy/moon.svg' },
  { id: 'diamond', label: '토끼', src: '/sichuan/themes/fantasy/diamond.svg' },
  { id: 'guitar', label: '돼지', src: '/sichuan/themes/fantasy/guitar.svg' },
  { id: 'book', label: '수달', src: '/sichuan/themes/fantasy/book.svg' },
  { id: 'planet', label: '공작', src: '/sichuan/themes/fantasy/planet.svg' },
  { id: 'flower', label: '개구리', src: '/sichuan/themes/fantasy/flower.svg' },
  { id: 'dragon', label: '병아리', src: '/sichuan/themes/fantasy/dragon.svg' },
  { id: 'sword', label: '햄스터', src: '/sichuan/themes/fantasy/sword.svg' },
  { id: 'shield', label: '코끼리', src: '/sichuan/themes/fantasy/shield.svg' },
  { id: 'teddy', label: '하마', src: '/sichuan/themes/fantasy/teddy.svg' },
  { id: 'skate', label: '매머드', src: '/sichuan/themes/fantasy/skate.svg' },
  { id: 'coffee', label: '멧돼지', src: '/sichuan/themes/fantasy/coffee.svg' },
  { id: 'ribbon', label: '아기공룡', src: '/sichuan/themes/fantasy/ribbon.svg' },
  { id: 'trident', label: '말랑곰', src: '/sichuan/themes/fantasy/trident.svg' },
  { id: 'sunglasses', label: '파타고티탄', src: '/sichuan/themes/fantasy/sunglasses.svg' },
  { id: 'briefcase', label: '아기용', src: '/sichuan/themes/fantasy/briefcase.svg' },
  { id: 'crystal', label: '대왕고래', src: '/sichuan/themes/fantasy/crystal.svg' }
];

const seaTiles = [
  { id: 'cat', label: '카메라', src: '/sichuan/themes/sea/cat.svg' },
  { id: 'soccer', label: '우산', src: '/sichuan/themes/sea/soccer.svg' },
  { id: 'crown', label: '로봇', src: '/sichuan/themes/sea/crown.svg' },
  { id: 'moon', label: '주사위', src: '/sichuan/themes/sea/moon.svg' },
  { id: 'diamond', label: '기타', src: '/sichuan/themes/sea/diamond.svg' },
  { id: 'guitar', label: '서류가방', src: '/sichuan/themes/sea/guitar.svg' },
  { id: 'book', label: '스케이트보드', src: '/sichuan/themes/sea/book.svg' },
  { id: 'planet', label: '축구공', src: '/sichuan/themes/sea/planet.svg' },
  { id: 'flower', label: '야구모자', src: '/sichuan/themes/sea/flower.svg' },
  { id: 'dragon', label: '게임헤드셋', src: '/sichuan/themes/sea/dragon.svg' },
  { id: 'sword', label: '곰돌이가방', src: '/sichuan/themes/sea/sword.svg' },
  { id: 'shield', label: '리본', src: '/sichuan/themes/sea/shield.svg' },
  { id: 'teddy', label: '실크햇', src: '/sichuan/themes/sea/teddy.svg' },
  { id: 'skate', label: '트로피', src: '/sichuan/themes/sea/skate.svg' },
  { id: 'coffee', label: '명품가방', src: '/sichuan/themes/sea/coffee.svg' },
  { id: 'ribbon', label: '선글라스', src: '/sichuan/themes/sea/ribbon.svg' },
  { id: 'trident', label: '꽃다발', src: '/sichuan/themes/sea/trident.svg' },
  { id: 'sunglasses', label: '아메리카노', src: '/sichuan/themes/sea/sunglasses.svg' },
  { id: 'briefcase', label: '블랙카드', src: '/sichuan/themes/sea/briefcase.svg' },
  { id: 'crystal', label: '곰인형', src: '/sichuan/themes/sea/crystal.svg' }
];

const techTiles = [
  { id: 'cat', label: '성검', src: '/sichuan/themes/tech/cat.svg' },
  { id: 'soccer', label: '방패', src: '/sichuan/themes/tech/soccer.svg' },
  { id: 'crown', label: '삼지창', src: '/sichuan/themes/tech/crown.svg' },
  { id: 'moon', label: '수정구', src: '/sichuan/themes/tech/moon.svg' },
  { id: 'diamond', label: '마법책', src: '/sichuan/themes/tech/diamond.svg' },
  { id: 'guitar', label: '마법봉', src: '/sichuan/themes/tech/guitar.svg' },
  { id: 'book', label: '황금왕관', src: '/sichuan/themes/tech/book.svg' },
  { id: 'planet', label: '왕좌', src: '/sichuan/themes/tech/planet.svg' },
  { id: 'flower', label: '불꽃문장', src: '/sichuan/themes/tech/flower.svg' },
  { id: 'dragon', label: '후광', src: '/sichuan/themes/tech/dragon.svg' },
  { id: 'sword', label: '악마날개', src: '/sichuan/themes/tech/sword.svg' },
  { id: 'shield', label: '유니콘', src: '/sichuan/themes/tech/shield.svg' },
  { id: 'teddy', label: '황금용', src: '/sichuan/themes/tech/teddy.svg' },
  { id: 'skate', label: '암흑망토', src: '/sichuan/themes/tech/skate.svg' },
  { id: 'coffee', label: '다이아몬드', src: '/sichuan/themes/tech/coffee.svg' },
  { id: 'ribbon', label: '별부적', src: '/sichuan/themes/tech/ribbon.svg' },
  { id: 'trident', label: '초승달', src: '/sichuan/themes/tech/trident.svg' },
  { id: 'sunglasses', label: '은하', src: '/sichuan/themes/tech/sunglasses.svg' },
  { id: 'briefcase', label: '포션', src: '/sichuan/themes/tech/briefcase.svg' },
  { id: 'crystal', label: '황금트로피', src: '/sichuan/themes/tech/crystal.svg' }
];

export const SICHUAN_THEMES = Object.freeze({
  life: Object.freeze({ key: 'life', label: '레고세상', tiles: Object.freeze(lifeTiles.map(Object.freeze)) }),
  nature: Object.freeze({ key: 'nature', label: '먹거리', tiles: Object.freeze(natureTiles.map(Object.freeze)) }),
  fantasy: Object.freeze({ key: 'fantasy', label: '동물원', tiles: Object.freeze(fantasyTiles.map(Object.freeze)) }),
  sea: Object.freeze({ key: 'sea', label: '일상잡화', tiles: Object.freeze(seaTiles.map(Object.freeze)) }),
  tech: Object.freeze({ key: 'tech', label: '판타지', tiles: Object.freeze(techTiles.map(Object.freeze)) })
});
