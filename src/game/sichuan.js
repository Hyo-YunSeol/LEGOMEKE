...
export const SICHUAN_TILES = Object.freeze([
  // Keep the legacy tile ids so a deployment never invalidates an in-progress persisted board.
  // Only the visible artwork/labels are refreshed.
  { id: 'cat', label: '사과', src: '/sichuan/apple.svg' },
  { id: 'soccer', label: '오리', src: '/sichuan/duck.svg' },
  { id: 'crown', label: '로켓', src: '/sichuan/rocket.svg' },
  { id: 'moon', label: '포션', src: '/sichuan/potion.svg' },
  { id: 'diamond', label: '선인장', src: '/sichuan/cactus.svg' },
  { id: 'guitar', label: '물고기', src: '/sichuan/fish.svg' },
  { id: 'book', label: '케이크', src: '/sichuan/cake.svg' },
  { id: 'planet', label: '카메라', src: '/sichuan/camera.svg' },
  { id: 'flower', label: '우산', src: '/sichuan/umbrella.svg' },
  { id: 'dragon', label: '고래', src: '/sichuan/whale.svg' },
  { id: 'sword', label: '버섯', src: '/sichuan/mushroom.svg' },
  { id: 'shield', label: '별', src: '/sichuan/star.svg' },
  { id: 'teddy', label: '개구리', src: '/sichuan/frog.svg' },
  { id: 'skate', label: '로봇', src: '/sichuan/robot.svg' },
  { id: 'coffee', label: '도넛', src: '/sichuan/donut.svg' },
  { id: 'ribbon', label: '번개', src: '/sichuan/lightning.svg' },
  { id: 'trident', label: '보물상자', src: '/sichuan/chest.svg' },
  { id: 'sunglasses', label: '유령', src: '/sichuan/ghost.svg' },
  { id: 'briefcase', label: '체리', src: '/sichuan/cherry.svg' },
  { id: 'crystal', label: '주사위', src: '/sichuan/dice.svg' }
]);
