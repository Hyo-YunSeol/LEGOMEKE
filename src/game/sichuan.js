...
export const SICHUAN_MAX_ROOMS = 5;
...
export const SICHUAN_STREAK_PENALTY_WINS = 3;
export const SICHUAN_STREAK_PENALTY_MS = 10_000;

export const SICHUAN_THEME_KEYS = Object.freeze(['life', 'nature', 'fantasy', 'sea', 'tech']);

const lifeTiles = [
  { id: 'cat', label: '사과', src: '/sichuan/themes/life/cat.svg' },
  { id: 'soccer', label: '오리', src: '/sichuan/themes/life/soccer.svg' },
  { id: 'crown', label: '로켓', src: '/sichuan/themes/life/crown.svg' },
  { id: 'moon', label: '포션', src: '/sichuan/themes/life/moon.svg' },
  { id: 'diamond', label: '선인장', src: '/sichuan/themes/life/diamond.svg' },
  { id: 'guitar', label: '물고기', src: '/sichuan/themes/life/guitar.svg' },
  { id: 'book', label: '케이크', src: '/sichuan/themes/life/book.svg' },
  { id: 'planet', label: '카메라', src: '/sichuan/themes/life/planet.svg' },
  { id: 'flower', label: '우산', src: '/sichuan/themes/life/flower.svg' },
  { id: 'dragon', label: '고래', src: '/sichuan/themes/life/dragon.svg' },
  { id: 'sword', label: '버섯', src: '/sichuan/themes/life/sword.svg' },
  { id: 'shield', label: '별', src: '/sichuan/themes/life/shield.svg' },
  { id: 'teddy', label: '개구리', src: '/sichuan/themes/life/teddy.svg' },
  { id: 'skate', label: '로봇', src: '/sichuan/themes/life/skate.svg' },
  { id: 'coffee', label: '도넛', src: '/sichuan/themes/life/coffee.svg' },
  { id: 'ribbon', label: '번개', src: '/sichuan/themes/life/ribbon.svg' },
  { id: 'trident', label: '보물상자', src: '/sichuan/themes/life/trident.svg' },
  { id: 'sunglasses', label: '유령', src: '/sichuan/themes/life/sunglasses.svg' },
  { id: 'briefcase', label: '체리', src: '/sichuan/themes/life/briefcase.svg' },
  { id: 'crystal', label: '주사위', src: '/sichuan/themes/life/crystal.svg' }
];

const natureTiles = [
  { id: 'cat', label: '고양이', src: '/sichuan/themes/nature/cat.svg' },
  { id: 'soccer', label: '강아지', src: '/sichuan/themes/nature/soccer.svg' },
  { id: 'crown', label: '사자', src: '/sichuan/themes/nature/crown.svg' },
  { id: 'moon', label: '수달', src: '/sichuan/themes/nature/moon.svg' },
  { id: 'diamond', label: '판다', src: '/sichuan/themes/nature/diamond.svg' },
  { id: 'guitar', label: '공작', src: '/sichuan/themes/nature/guitar.svg' },
  { id: 'book', label: '돼지', src: '/sichuan/themes/nature/book.svg' },
  { id: 'planet', label: '토끼', src: '/sichuan/themes/nature/planet.svg' },
  { id: 'flower', label: '늑대', src: '/sichuan/themes/nature/flower.svg' },
  { id: 'dragon', label: '유니콘', src: '/sichuan/themes/nature/dragon.svg' },
  { id: 'sword', label: '아기용', src: '/sichuan/themes/nature/sword.svg' },
  { id: 'shield', label: '황금용', src: '/sichuan/themes/nature/shield.svg' },
  { id: 'teddy', label: '곰', src: '/sichuan/themes/nature/teddy.svg' },
  { id: 'skate', label: '벚꽃', src: '/sichuan/themes/nature/skate.svg' },
  { id: 'coffee', label: '꽃다발', src: '/sichuan/themes/nature/coffee.svg' },
  { id: 'ribbon', label: '개구리', src: '/sichuan/themes/nature/ribbon.svg' },
  { id: 'trident', label: '병아리', src: '/sichuan/themes/nature/trident.svg' },
  { id: 'sunglasses', label: '햄스터', src: '/sichuan/themes/nature/sunglasses.svg' },
  { id: 'briefcase', label: '아기돼지', src: '/sichuan/themes/nature/briefcase.svg' },
  { id: 'crystal', label: '검은늑대', src: '/sichuan/themes/nature/crystal.svg' }
];

const fantasyTiles = [
  { id: 'cat', label: '검', src: '/sichuan/themes/fantasy/cat.svg' },
  { id: 'soccer', label: '방패', src: '/sichuan/themes/fantasy/soccer.svg' },
  { id: 'crown', label: '삼지창', src: '/sichuan/themes/fantasy/crown.svg' },
  { id: 'moon', label: '수정구', src: '/sichuan/themes/fantasy/moon.svg' },
  { id: 'diamond', label: '마법책', src: '/sichuan/themes/fantasy/diamond.svg' },
  { id: 'guitar', label: '마법봉', src: '/sichuan/themes/fantasy/guitar.svg' },
  { id: 'book', label: '트로피', src: '/sichuan/themes/fantasy/book.svg' },
  { id: 'planet', label: '왕관', src: '/sichuan/themes/fantasy/planet.svg' },
  { id: 'flower', label: '블랙카드', src: '/sichuan/themes/fantasy/flower.svg' },
  { id: 'dragon', label: '행성', src: '/sichuan/themes/fantasy/dragon.svg' },
  { id: 'sword', label: '초승달', src: '/sichuan/themes/fantasy/sword.svg' },
  { id: 'shield', label: '별참', src: '/sichuan/themes/fantasy/shield.svg' },
  { id: 'teddy', label: '후광', src: '/sichuan/themes/fantasy/teddy.svg' },
  { id: 'skate', label: '악마날개', src: '/sichuan/themes/fantasy/skate.svg' },
  { id: 'coffee', label: '천사날개', src: '/sichuan/themes/fantasy/coffee.svg' },
  { id: 'ribbon', label: '은하', src: '/sichuan/themes/fantasy/ribbon.svg' },
  { id: 'trident', label: '불꽃', src: '/sichuan/themes/fantasy/trident.svg' },
  { id: 'sunglasses', label: '돈다발', src: '/sichuan/themes/fantasy/sunglasses.svg' },
  { id: 'briefcase', label: '금괴', src: '/sichuan/themes/fantasy/briefcase.svg' },
  { id: 'crystal', label: '왕좌', src: '/sichuan/themes/fantasy/crystal.svg' }

];

const seaTiles = [
  { id: 'cat', label: '상어', src: '/sichuan/themes/sea/cat.svg' },
  { id: 'soccer', label: '문어', src: '/sichuan/themes/sea/soccer.svg' },
  { id: 'crown', label: '해파리', src: '/sichuan/themes/sea/crown.svg' },
  { id: 'moon', label: '돌고래', src: '/sichuan/themes/sea/moon.svg' },
  { id: 'diamond', label: '바다거북', src: '/sichuan/themes/sea/diamond.svg' },
  { id: 'guitar', label: '게', src: '/sichuan/themes/sea/guitar.svg' },
  { id: 'book', label: '조개', src: '/sichuan/themes/sea/book.svg' },
  { id: 'planet', label: '불가사리', src: '/sichuan/themes/sea/planet.svg' },
  { id: 'flower', label: '산호', src: '/sichuan/themes/sea/flower.svg' },
  { id: 'dragon', label: '고래', src: '/sichuan/themes/sea/dragon.svg' },
  { id: 'sword', label: '해변', src: '/sichuan/themes/sea/sword.svg' },
  { id: 'shield', label: '닻', src: '/sichuan/themes/sea/shield.svg' },
  { id: 'teddy', label: '범선', src: '/sichuan/themes/sea/teddy.svg' },
  { id: 'skate', label: '야자수', src: '/sichuan/themes/sea/skate.svg' },
  { id: 'coffee', label: '튜브', src: '/sichuan/themes/sea/coffee.svg' },
  { id: 'ribbon', label: '파도', src: '/sichuan/themes/sea/ribbon.svg' },
  { id: 'trident', label: '수박', src: '/sichuan/themes/sea/trident.svg' },
  { id: 'sunglasses', label: '선글라스', src: '/sichuan/themes/sea/sunglasses.svg' },
  { id: 'briefcase', label: '아이스크림', src: '/sichuan/themes/sea/briefcase.svg' },
  { id: 'crystal', label: '서핑', src: '/sichuan/themes/sea/crystal.svg' }
];

const techTiles = [
  { id: 'cat', label: 'UFO', src: '/sichuan/themes/tech/cat.svg' },
  { id: 'soccer', label: '우주선', src: '/sichuan/themes/tech/soccer.svg' },
  { id: 'crown', label: '외계인', src: '/sichuan/themes/tech/crown.svg' },
  { id: 'moon', label: '인공위성', src: '/sichuan/themes/tech/moon.svg' },
  { id: 'diamond', label: '로봇', src: '/sichuan/themes/tech/diamond.svg' },
  { id: 'guitar', label: '행성', src: '/sichuan/themes/tech/guitar.svg' },
  { id: 'book', label: '혜성', src: '/sichuan/themes/tech/book.svg' },
  { id: 'planet', label: '우주인', src: '/sichuan/themes/tech/planet.svg' },
  { id: 'flower', label: '안테나', src: '/sichuan/themes/tech/flower.svg' },
  { id: 'dragon', label: '반도체칩', src: '/sichuan/themes/tech/dragon.svg' },
  { id: 'sword', label: '컨트롤러', src: '/sichuan/themes/tech/sword.svg' },
  { id: 'shield', label: '배터리', src: '/sichuan/themes/tech/shield.svg' },
  { id: 'teddy', label: '신호', src: '/sichuan/themes/tech/teddy.svg' },
  { id: 'skate', label: '망원경', src: '/sichuan/themes/tech/skate.svg' },
  { id: 'coffee', label: '블랙홀', src: '/sichuan/themes/tech/coffee.svg' },
  { id: 'ribbon', label: '키보드', src: '/sichuan/themes/tech/ribbon.svg' },
  { id: 'trident', label: '모니터', src: '/sichuan/themes/tech/trident.svg' },
  { id: 'sunglasses', label: '기어', src: '/sichuan/themes/tech/sunglasses.svg' },
  { id: 'briefcase', label: '플러그', src: '/sichuan/themes/tech/briefcase.svg' },
  { id: 'crystal', label: '전구', src: '/sichuan/themes/tech/crystal.svg' }
];

export const SICHUAN_THEMES = Object.freeze({
  life: Object.freeze({ key: 'life', label: '생활·먹거리', tiles: Object.freeze(lifeTiles.map(Object.freeze)) }),
  nature: Object.freeze({ key: 'nature', label: '동물·자연', tiles: Object.freeze(natureTiles.map(Object.freeze)) }),
  fantasy: Object.freeze({ key: 'fantasy', label: '게임·판타지', tiles: Object.freeze(fantasyTiles.map(Object.freeze)) }),
  sea: Object.freeze({ key: 'sea', label: '바다·여름', tiles: Object.freeze(seaTiles.map(Object.freeze)) }),
  tech: Object.freeze({ key: 'tech', label: '우주·테크', tiles: Object.freeze(techTiles.map(Object.freeze)) })
});

// Board equality uses stable legacy ids. Artwork changes only through the room theme.
export const SICHUAN_TILES = SICHUAN_THEMES.life.tiles;
...
function normalizeThemeKey(value) {
  ...
  return SICHUAN_THEME_KEYS.includes(key) ? key : 'life';
}

function nextThemeKey(previousKey = null) {
  const candidates = SICHUAN_THEME_KEYS.filter((key) => key !== previousKey);
  return candidates[Math.floor(Math.random() * candidates.length)] ?? 'life';
}
...
export function normalizeSichuan(raw, state, date = new Date()) {
  ...
  for (const [roomId, rawRoom] of Object.entries(game.rooms)) {
    ...
    room.status = status;
    room.themeKey = normalizeThemeKey(room.themeKey);
    ...
    room.streakPenaltyUntil = room.streakPenaltyUntil && typeof room.streakPenaltyUntil === 'object' && !Array.isArray(room.streakPenaltyUntil) ? room.streakPenaltyUntil : {};
    room.startWinStreaks = room.startWinStreaks && typeof room.startWinStreaks === 'object' && !Array.isArray(room.startWinStreaks) ? room.startWinStreaks : {};
    for (const petId of [host.id, guest?.id].filter(Boolean)) {
      const until = new Date(room.streakPenaltyUntil[petId] ?? '').getTime();
      room.streakPenaltyUntil[petId] = Number.isFinite(until) ? new Date(until).toISOString() : null;
      room.startWinStreaks[petId] = Math.max(0, int(room.startWinStreaks[petId]));
    }
...
function normalizeSichuanWinStreak(pet, date = new Date()) {
  if (!pet) return 0;
  pet.daily ??= {};
  const key = gameDayKey(date);
  if (pet.daily.sichuanStreakDayKey !== key) {
    pet.daily.sichuanStreakDayKey = key;
    pet.daily.sichuanWinStreak = 0;
  }
  pet.daily.sichuanWinStreak = Math.max(0, int(pet.daily.sichuanWinStreak));
  return pet.daily.sichuanWinStreak;
}

function setSichuanWinStreak(pet, value, date = new Date()) {
  if (!pet) return 0;
  normalizeSichuanWinStreak(pet, date);
  pet.daily.sichuanWinStreak = Math.max(0, int(value));
  return pet.daily.sichuanWinStreak;
}

function penaltyUntilForStreak(streak, date = new Date()) {
  return streak >= SICHUAN_STREAK_PENALTY_WINS ? new Date(date.getTime() + SICHUAN_STREAK_PENALTY_MS).toISOString() : null;
}
...
function finishWin(state, room, winnerPetId, loserPetId, reason, date = new Date()) {
  ...
  setSichuanWinStreak(winner, normalizeSichuanWinStreak(winner, date) + 1, date);
  setSichuanWinStreak(loser, 0, date);
...
function finishDraw(state, room, reason, date = new Date()) {
  ...
  for (const petId of [room.hostPetId, room.guestPetId]) {
    ...
    if (pet?.alive) {
      ...
      setSichuanWinStreak(pet, 0, date);
...
function startMatch(state, room, date = new Date()) {
  ...
  const battleConsumed = consumeBattleForPets([host, guest], date);
  if (!battleConsumed.ok) { host.stats.points += room.stakePoints; host.records.pointsSpent -= room.stakePoints; guest.stats.points += room.stakePoints; guest.records.pointsSpent -= room.stakePoints; return battleConsumed; }
  const board = generateSichuanBoard();
  const hostWinStreak = normalizeSichuanWinStreak(host, date);
  const guestWinStreak = normalizeSichuanWinStreak(guest, date);
  room.themeKey = nextThemeKey(room.startedAt ? room.themeKey : null);
  room.startWinStreaks = { [host.id]: hostWinStreak, [guest.id]: guestWinStreak };
  room.streakPenaltyUntil = {
    [host.id]: penaltyUntilForStreak(hostWinStreak, date),
    [guest.id]: penaltyUntilForStreak(guestWinStreak, date)
  };
...
export function createSichuanRoom(state, pet, stakeValue, date = new Date()) {
  ...
  if (Object.values(game.rooms).filter((room) => room.status !== 'ended').length >= SICHUAN_MAX_ROOMS) return { ok: false, message: '동시에 운영할 수 있는 사천성 대전방 5개가 모두 사용 중입니다.' };
  if (pet.stats.points < Number(stakeValue)) return { ok: false, message: `판돈 ${stakeValue}P가 필요합니다.` };
  const roomNumber = nextRoomNumber(game);
  const room = {
    id: id('sichuanroom'), roomNumber, status: 'waiting', themeKey: null, hostPetId: pet.id, guestPetId: null,
    ...
    winnerPetId: null, loserPetId: null, result: null, resultReason: null, streakPenaltyUntil: {}, startWinStreaks: {},
...
export function playSichuanPair(state, pet, roomId, input = {}, date = new Date()) {
  ...
  const penaltyUntil = new Date(room.streakPenaltyUntil?.[pet.id] ?? '').getTime();
  if (Number.isFinite(penaltyUntil) && date.getTime() < penaltyUntil) {
    return { ok: false, penalty: true, retryAfterMs: Math.max(1, penaltyUntil - date.getTime()), message: '연승 패널티로 시작 후 10초 동안 패를 선택할 수 없습니다.' };
  }
...
function publicRoomView(state, room, viewerPetId, date = new Date()) {
  ...
  return {
    id: room.id, roomNumber: room.roomNumber, status: room.status, stakePoints: room.stakePoints, themeKey: room.themeKey,
    ...
    streakPenaltyUntil: Object.fromEntries([room.hostPetId, room.guestPetId].filter(Boolean).map((petId) => [petId, room.streakPenaltyUntil?.[petId] ?? null])),
    startWinStreaks: Object.fromEntries([room.hostPetId, room.guestPetId].filter(Boolean).map((petId) => [petId, Math.max(0, int(room.startWinStreaks?.[petId]))])),
...
export function sichuanView(state, viewerPetId, date = new Date()) {
  ...
  return {
    ...
    themes: SICHUAN_THEME_KEYS.map((key) => ({ key, label: SICHUAN_THEMES[key].label, tiles: SICHUAN_THEMES[key].tiles.map((tile) => ({ ...tile })) })),
