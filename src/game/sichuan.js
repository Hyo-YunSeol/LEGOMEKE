...
export const SICHUAN_THEME_KEYS = Object.freeze(['neon', 'ocean', 'camp', 'music', 'space']);

const neonTiles = [
  { id: 'cat', label: '택시', src: '/sichuan/themes/neon/cat.svg' },
  { id: 'soccer', label: '신호등', src: '/sichuan/themes/neon/soccer.svg' },
  { id: 'crown', label: '야경빌딩', src: '/sichuan/themes/neon/crown.svg' },
  { id: 'moon', label: '전화부스', src: '/sichuan/themes/neon/moon.svg' },
  { id: 'diamond', label: '지하철', src: '/sichuan/themes/neon/diamond.svg' },
  { id: 'guitar', label: '스쿠터', src: '/sichuan/themes/neon/guitar.svg' },
  { id: 'book', label: '카메라', src: '/sichuan/themes/neon/book.svg' },
  { id: 'planet', label: '우산', src: '/sichuan/themes/neon/planet.svg' },
  { id: 'flower', label: '쇼핑백', src: '/sichuan/themes/neon/flower.svg' },
  { id: 'dragon', label: '열쇠', src: '/sichuan/themes/neon/dragon.svg' },
  { id: 'sword', label: '손목시계', src: '/sichuan/themes/neon/sword.svg' },
  { id: 'shield', label: '도시지도', src: '/sichuan/themes/neon/shield.svg' },
  { id: 'teddy', label: '버스', src: '/sichuan/themes/neon/teddy.svg' },
  { id: 'skate', label: '횡단표지', src: '/sichuan/themes/neon/skate.svg' },
  { id: 'coffee', label: '공연티켓', src: '/sichuan/themes/neon/coffee.svg' },
  { id: 'ribbon', label: '지갑', src: '/sichuan/themes/neon/ribbon.svg' },
  { id: 'trident', label: '네온전구', src: '/sichuan/themes/neon/trident.svg' },
  { id: 'sunglasses', label: '택배상자', src: '/sichuan/themes/neon/sunglasses.svg' },
  { id: 'briefcase', label: '고층호텔', src: '/sichuan/themes/neon/briefcase.svg' },
  { id: 'crystal', label: '심야편의점', src: '/sichuan/themes/neon/crystal.svg' }
];

const oceanTiles = [
  { id: 'cat', label: '상어', src: '/sichuan/themes/ocean/cat.svg' },
  { id: 'soccer', label: '고래', src: '/sichuan/themes/ocean/soccer.svg' },
  { id: 'crown', label: '문어', src: '/sichuan/themes/ocean/crown.svg' },
  { id: 'moon', label: '오징어', src: '/sichuan/themes/ocean/moon.svg' },
  { id: 'diamond', label: '돌고래', src: '/sichuan/themes/ocean/diamond.svg' },
  { id: 'guitar', label: '열대어', src: '/sichuan/themes/ocean/guitar.svg' },
  { id: 'book', label: '복어', src: '/sichuan/themes/ocean/book.svg' },
  { id: 'planet', label: '게', src: '/sichuan/themes/ocean/planet.svg' },
  { id: 'flower', label: '새우', src: '/sichuan/themes/ocean/flower.svg' },
  { id: 'dragon', label: '해파리', src: '/sichuan/themes/ocean/dragon.svg' },
  { id: 'sword', label: '조개', src: '/sichuan/themes/ocean/sword.svg' },
  { id: 'shield', label: '산호', src: '/sichuan/themes/ocean/shield.svg' },
  { id: 'teddy', label: '닻', src: '/sichuan/themes/ocean/teddy.svg' },
  { id: 'skate', label: '구명튜브', src: '/sichuan/themes/ocean/skate.svg' },
  { id: 'coffee', label: '보트', src: '/sichuan/themes/ocean/coffee.svg' },
  { id: 'ribbon', label: '범선', src: '/sichuan/themes/ocean/ribbon.svg' },
  { id: 'trident', label: '다이빙마스크', src: '/sichuan/themes/ocean/trident.svg' },
  { id: 'sunglasses', label: '파도', src: '/sichuan/themes/ocean/sunglasses.svg' },
  { id: 'briefcase', label: '무인도', src: '/sichuan/themes/ocean/briefcase.svg' },
  { id: 'crystal', label: '수영', src: '/sichuan/themes/ocean/crystal.svg' }
];

const campTiles = [
  { id: 'cat', label: '텐트', src: '/sichuan/themes/camp/cat.svg' },
  { id: 'soccer', label: '모닥불', src: '/sichuan/themes/camp/soccer.svg' },
  { id: 'crown', label: '랜턴', src: '/sichuan/themes/camp/crown.svg' },
  { id: 'moon', label: '배낭', src: '/sichuan/themes/camp/moon.svg' },
  { id: 'diamond', label: '나침반', src: '/sichuan/themes/camp/diamond.svg' },
  { id: 'guitar', label: '등산화', src: '/sichuan/themes/camp/guitar.svg' },
  { id: 'book', label: '손전등', src: '/sichuan/themes/camp/book.svg' },
  { id: 'planet', label: '침대', src: '/sichuan/themes/camp/planet.svg' },
  { id: 'flower', label: '머그컵', src: '/sichuan/themes/camp/flower.svg' },
  { id: 'dragon', label: '꼬치', src: '/sichuan/themes/camp/dragon.svg' },
  { id: 'sword', label: '통조림', src: '/sichuan/themes/camp/sword.svg' },
  { id: 'shield', label: '도끼', src: '/sichuan/themes/camp/shield.svg' },
  { id: 'teddy', label: '장작', src: '/sichuan/themes/camp/teddy.svg' },
  { id: 'skate', label: '망원경', src: '/sichuan/themes/camp/skate.svg' },
  { id: 'coffee', label: '설산', src: '/sichuan/themes/camp/coffee.svg' },
  { id: 'ribbon', label: '소나무', src: '/sichuan/themes/camp/ribbon.svg' },
  { id: 'trident', label: '버섯', src: '/sichuan/themes/camp/trident.svg' },
  { id: 'sunglasses', label: '별밤', src: '/sichuan/themes/camp/sunglasses.svg' },
  { id: 'briefcase', label: '캠핑카', src: '/sichuan/themes/camp/briefcase.svg' },
  { id: 'crystal', label: '캠핑의자', src: '/sichuan/themes/camp/crystal.svg' }
];

const musicTiles = [
  { id: 'cat', label: '마이크', src: '/sichuan/themes/music/cat.svg' },
  { id: 'soccer', label: '기타', src: '/sichuan/themes/music/soccer.svg' },
  { id: 'crown', label: '드럼', src: '/sichuan/themes/music/crown.svg' },
  { id: 'moon', label: '피아노', src: '/sichuan/themes/music/moon.svg' },
  { id: 'diamond', label: '바이올린', src: '/sichuan/themes/music/diamond.svg' },
  { id: 'guitar', label: '색소폰', src: '/sichuan/themes/music/guitar.svg' },
  { id: 'book', label: '트럼펫', src: '/sichuan/themes/music/book.svg' },
  { id: 'planet', label: '헤드폰', src: '/sichuan/themes/music/planet.svg' },
  { id: 'flower', label: '스피커', src: '/sichuan/themes/music/flower.svg' },
  { id: 'dragon', label: '악보', src: '/sichuan/themes/music/dragon.svg' },
  { id: 'sword', label: '음표', src: '/sichuan/themes/music/sword.svg' },
  { id: 'shield', label: '디스코볼', src: '/sichuan/themes/music/shield.svg' },
  { id: 'teddy', label: '입장권', src: '/sichuan/themes/music/teddy.svg' },
  { id: 'skate', label: 'CD', src: '/sichuan/themes/music/skate.svg' },
  { id: 'coffee', label: '카세트', src: '/sichuan/themes/music/coffee.svg' },
  { id: 'ribbon', label: '라디오', src: '/sichuan/themes/music/ribbon.svg' },
  { id: 'trident', label: '메가폰', src: '/sichuan/themes/music/trident.svg' },
  { id: 'sunglasses', label: '마라카스', src: '/sichuan/themes/music/sunglasses.svg' },
  { id: 'briefcase', label: '아코디언', src: '/sichuan/themes/music/briefcase.svg' },
  { id: 'crystal', label: '클래퍼', src: '/sichuan/themes/music/crystal.svg' }
];

const spaceTiles = [
  { id: 'cat', label: '로켓', src: '/sichuan/themes/space/cat.svg' },
  { id: 'soccer', label: '우주인', src: '/sichuan/themes/space/soccer.svg' },
  { id: 'crown', label: 'UFO', src: '/sichuan/themes/space/crown.svg' },
  { id: 'moon', label: '지구', src: '/sichuan/themes/space/moon.svg' },
  { id: 'diamond', label: '보름달', src: '/sichuan/themes/space/diamond.svg' },
  { id: 'guitar', label: '토성', src: '/sichuan/themes/space/guitar.svg' },
  { id: 'book', label: '별', src: '/sichuan/themes/space/book.svg' },
  { id: 'planet', label: '혜성', src: '/sichuan/themes/space/planet.svg' },
  { id: 'flower', label: '위성', src: '/sichuan/themes/space/flower.svg' },
  { id: 'dragon', label: '천체망원경', src: '/sichuan/themes/space/dragon.svg' },
  { id: 'sword', label: '현미경', src: '/sichuan/themes/space/sword.svg' },
  { id: 'shield', label: 'DNA', src: '/sichuan/themes/space/shield.svg' },
  { id: 'teddy', label: '시험관', src: '/sichuan/themes/space/teddy.svg' },
  { id: 'skate', label: '플라스크', src: '/sichuan/themes/space/skate.svg' },
  { id: 'coffee', label: '자석', src: '/sichuan/themes/space/coffee.svg' },
  { id: 'ribbon', label: '원자', src: '/sichuan/themes/space/ribbon.svg' },
  { id: 'trident', label: '로봇', src: '/sichuan/themes/space/trident.svg' },
  { id: 'sunglasses', label: '안테나', src: '/sichuan/themes/space/sunglasses.svg' },
  { id: 'briefcase', label: '운석', src: '/sichuan/themes/space/briefcase.svg' },
  { id: 'crystal', label: '블랙홀', src: '/sichuan/themes/space/crystal.svg' }
];

export const SICHUAN_THEMES = Object.freeze({
  neon: Object.freeze({ key: 'neon', label: '네온시티', tiles: Object.freeze(neonTiles.map(Object.freeze)) }),
  ocean: Object.freeze({ key: 'ocean', label: '바다탐험', tiles: Object.freeze(oceanTiles.map(Object.freeze)) }),
  camp: Object.freeze({ key: 'camp', label: '캠핑데이', tiles: Object.freeze(campTiles.map(Object.freeze)) }),
  music: Object.freeze({ key: 'music', label: '음악축제', tiles: Object.freeze(musicTiles.map(Object.freeze)) }),
  space: Object.freeze({ key: 'space', label: '우주연구소', tiles: Object.freeze(spaceTiles.map(Object.freeze)) })
});
// Board equality uses stable legacy ids. Artwork changes only through the room theme.
export const SICHUAN_TILES = SICHUAN_THEMES.neon.tiles;
...
function normalizeThemeKey(value) {
  ...
  return SICHUAN_THEME_KEYS.includes(key) ? key : 'neon';
}

function nextThemeKey(previousKey = null) {
  const candidates = SICHUAN_THEME_KEYS.filter((key) => key !== previousKey);
  return candidates[Math.floor(Math.random() * candidates.length)] ?? 'neon';
}
...
export function leaveSichuanRoom(state, pet, roomId, date = new Date()) {
  ...
  if (room.status === 'playing') {
    finishWin(state, room, opponentId(room, pet.id), pet.id, `${withJosa(pet.displayName, '이/가')} 나가 기권패했습니다.`, date);
...
export function playSichuanPair(state, pet, roomId, input = {}, date = new Date()) {
  ...
  if (player.removedCount >= SICHUAN_TILE_COUNT || player.board.every((tile) => !tile)) {
    ...
    finishWin(state, room, pet.id, opponentId(room, pet.id), `${withJosa(pet.displayName, '이/가')} 모든 패를 먼저 제거했습니다.`, date);
