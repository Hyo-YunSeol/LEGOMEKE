...
export function processGameRankingSeason(state, date = new Date()) {
  ...
  const champions = [
['apple', apple[0]], ['singleTetris', singleTetris[0]], ['omok', omok[0]], ['blockBattle', blockBattle[0]]
  ];
  ...
  return { changed: true, events, awards: { apple, singleTetris, omok, blockBattle, sichuan, davinci } };
}
