...
const LIFE_HUNGER_COSTS = Object.freeze({
  1: Object.freeze({ work: 4, rest: 2, exercise: 6 }),
  2: Object.freeze({ work: 4, rest: 2, exercise: 6 }),
  3: Object.freeze({ work: 5, rest: 2, exercise: 7 }),
  4: Object.freeze({ work: 5, rest: 3, exercise: 7 }),
  5: Object.freeze({ work: 6, rest: 3, exercise: 8 }),
  6: Object.freeze({ work: 6, rest: 3, exercise: 8 }),
  7: Object.freeze({ work: 7, rest: 4, exercise: 9 }),
  8: Object.freeze({ work: 7, rest: 4, exercise: 9 }),
  9: Object.freeze({ work: 8, rest: 4, exercise: 10 }),
  10: Object.freeze({ work: 8, rest: 5, exercise: 10 })
});
...
export function consumeInteractionHunger(pet, date = new Date()) {
  // 반복 콘텐츠(게임·교미·영토전·낚시)는 몸집과 무관하게 1만 소모한다.
  // 몸집별 차이는 일하기/쉬기/헬스 같은 생활 행동에만 유지한다.
  return consumeHunger(pet, 1, date);
}
