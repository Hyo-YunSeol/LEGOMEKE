...
export function publicProfile(state, targetPetId, viewerPetId, isOnline = false) {
  ...
  return {
    ...
    statusMessage: pet.statusMessage, levelBadge: levelBadgeForLevel(progress.level), seasonBadges: seasonBadgeView(pet), flexItem: flexItemView(pet),
