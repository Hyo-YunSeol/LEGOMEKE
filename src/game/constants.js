...
export const BODY_STAGES = [
  ...
  { min: 8750, max: 9699, key: 'leviathan', assetKey: 'lego-leviathan', label: '레비아탄레고', activityHungerCost: 7 },
  // 신화편: 레비아탄 이후에도 성장 목표가 끊기지 않도록 세계 신화의 거대 존재를 단계적으로 확장한다.
  // 후반 성장이 벌칙이 되지 않도록 게임·교미·영토 포만감 소모는 -7에서 더 증가시키지 않는다.
  { min: 9700, max: 10699, key: 'behemoth', assetKey: 'lego-behemoth', label: '베헤모스레고', activityHungerCost: 7 },
  { min: 10700, max: 11799, key: 'fenrir', assetKey: 'lego-fenrir', label: '펜리르레고', activityHungerCost: 7 },
  { min: 11800, max: 12999, key: 'hydra', assetKey: 'lego-hydra', label: '히드라레고', activityHungerCost: 7 },
  { min: 13000, max: 14299, key: 'orochi', assetKey: 'lego-orochi', label: '오로치레고', activityHungerCost: 7 },
  { min: 14300, max: 15699, key: 'garuda', assetKey: 'lego-garuda', label: '가루다레고', activityHungerCost: 7 },
  { min: 15700, max: 17199, key: 'nidhogg', assetKey: 'lego-nidhogg', label: '니드호그레고', activityHungerCost: 7 },
  { min: 17200, max: 18799, key: 'jormungandr', assetKey: 'lego-jormungandr', label: '요르문간드레고', activityHungerCost: 7 },
  { min: 18800, max: 20499, key: 'apep', assetKey: 'lego-apep', label: '아펩레고', activityHungerCost: 7 },
  { min: 20500, max: 22299, key: 'atlas', assetKey: 'lego-atlas', label: '아틀라스레고', activityHungerCost: 7 },
  { min: 22300, max: 24199, key: 'surtr', assetKey: 'lego-surtr', label: '수르트레고', activityHungerCost: 7 },
  { min: 24200, max: 26199, key: 'typhon', assetKey: 'lego-typhon', label: '티폰레고', activityHungerCost: 7 },
  // 다음 확장 때 이 단계의 max만 닫고 천체/우주편을 뒤에 이어 붙일 수 있다.
  { min: 26200, max: Infinity, key: 'myth-disaster', assetKey: 'lego-myth-disaster', label: '신화재앙레고', activityHungerCost: 7 }
];
...
export const SHOP_ITEMS = Object.freeze({
  ...
  battle20: Object.freeze({ id: 'battle20', icon: '⚔️', name: '대전 +20회권', price: 6000, description: '구매할 때마다 이번 게임 하루의 오목·테트리스대전·사천성·틀린그림찾기·다빈치코드 합산 한도를 20회 늘립니다.' }),
