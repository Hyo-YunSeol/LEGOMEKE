...
export const FLEX_ITEMS = Object.freeze({
  ...
  sunglasses: flexItem('sunglasses', '선글라스', 500, 1, 'sunglasses', '레고에 선글라스를 장착합니다.'),
  headset: flexItem('headset', '헤드셋', 500, 1, 'headset', '레고에 헤드셋을 장착합니다.'),
  champagne: flexItem('champagne', '샴페인', 1000, 2, 'champagne', '레고 옆에 샴페인을 장착합니다.'),
  pig: flexItem('pig', '돼지', 1000, 2, 'pig', '레고 옆에 작은 돼지를 장착합니다.'),
  dog: flexItem('dog', '강아지', 1000, 2, 'dog', '레고 옆에 작은 강아지를 장착합니다.'),
  cat: flexItem('cat', '고양이', 1000, 2, 'cat', '레고 옆에 작은 고양이를 장착합니다.'),
  trophy: flexItem('trophy', '트로피', 1500, 3, 'trophy', '레고 옆에 트로피를 장착하고 전용 이름표를 적용합니다.'),
  angelWings: flexItem('angelWings', '천사 날개', 2000, 4, 'angel-wings', '레고 뒤에 천사 날개를 장착하고 전용 천사 이름표를 적용합니다.')
});
