...
export const SHOP_ITEMS = Object.freeze({
  ...
  battle20: Object.freeze({ id: 'battle20', icon: '⚔️', name: '대전 +20회권', price: 4000, description: '구매할 때마다 이번 게임 하루의 오목·테트리스대전·사천성·레고도쿠 합산 한도를 20회 늘립니다.' }),
...
export const MINI_GAMES = {
  ...
  block: {
    id: 'block',
    name: '블록게임',
    description: '난이도 쉬움 · 같은 색 블록 2개 이상을 눌러 더 이상 지울 수 없을 때까지 진행합니다.',
    rewardType: 'points'
  },
  tetrisSingle: {
    id: 'tetrisSingle',
