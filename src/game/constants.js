...
export const TERRITORY_STEAL_COST = 20;
...
export const SHOP_ITEMS = Object.freeze({
  miniGame10: Object.freeze({ id: 'miniGame10', icon: '🎮', name: '미니게임 +10회권', price: 300, description: '이번 게임 하루의 개인게임 한도를 10회 늘립니다.' }),
  fishing5: Object.freeze({ id: 'fishing5', icon: '🎣', name: '낚시 +5회권', price: 200, description: '이번 게임 하루의 낚시 한도를 5회 늘립니다.' }),
  nickname24h: Object.freeze({ id: 'nickname24h', icon: '🪪', name: '24시간 닉변권', price: 500, description: '24시간 동안 임시 닉네임을 사용하고 만료 후 자동 복귀합니다.' }),
  lottery: Object.freeze({ id: 'lottery', icon: '🍀', name: '하루 복권', price: 100, retryPrice: 500, description: '첫 도전 100P, 추가 도전 500P. 최대 5,000P가 나옵니다.' }),
  staminaHour: Object.freeze({ id: 'staminaHour', icon: '🔋', name: '체력 1시간 100% 유지권', price: 300, description: '즉시 체력 100%. 1시간 동안 감소하지 않습니다.' }),
  hungerHour: Object.freeze({ id: 'hungerHour', icon: '🍖', name: '배고픔 1시간 100% 유지권', price: 500, description: '즉시 배고픔 100%. 1시간 동안 감소하지 않습니다.' })
});
